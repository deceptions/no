    ...
    override fun onMeasure(widthMeasureSpec: Int, heightMeasureSpec: Int) {
        ...
        for (i in 0 until childCount) {
            ...
            if (currentChildHookPointx + childWidth > realWidth) {
                //new line
                currentWidth = currentWidth.coerceAtLeast(currentChildHookPointx)

                //reset for new line
                currentChildHookPointx = 0
                currentChildHookPointy += childHeight
            }
            val nextChildHookPointx: Int = currentChildHookPointx + childWidth
            val nextChildHookPointy: Int = currentChildHookPointy
            currentHeight = currentHeight.coerceAtLeast(currentChildHookPointy + childHeight)
        ...
        currentWidth = currentChildHookPointx.coerceAtLeast(currentWidth)
